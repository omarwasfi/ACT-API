...
namespace ACT.Services.ApiDbAccess.HRMS_SUN
{
    public class HRMS_REPORT_SUN_DETAIL : IHRMS_REPORT_SUN_DETAIL
    {
        ...
        public async Task LoadDefaults()
        {
            ...
            _apiDbContext.HRMS_REPORT_SUN_DETAILS.Add(new HRMS_REPORT_SUN_DETAIL_Model() { SunAttribute = "PSTG_HDR_ID", IsConst = false, AutoGenerated = true, ValueType = "int" });
            ...
            _apiDbContext.HRMS_REPORT_SUN_DETAILS.Add(new HRMS_REPORT_SUN_DETAIL_Model() { SunAttribute = "PERD", IsConst = false, AutoGenerated = false, ValueType = "int", MapWithHRMS= "JV_Report_Details_ID" });
