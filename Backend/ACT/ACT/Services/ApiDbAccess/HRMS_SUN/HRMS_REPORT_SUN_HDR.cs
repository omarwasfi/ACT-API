...
namespace ACT.Services.ApiDbAccess.HRMS_SUN
{
    public class HRMS_REPORT_SUN_HDR : IHRMS_REPORT_SUN_HDR
    {
        ...
        public async Task LoadDefaults()
        {
            ...
            _apiDbContext.HRMS_REPORT_SUN_HDRS.Add(new HRMS_REPORT_SUN_HDR_Model() { SunAttribute = "POST_BAL_BY", IsConst = true, AutoGenerated = false, ValueType = "string", StringValue = "" });
